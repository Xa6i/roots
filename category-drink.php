      ...
      <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        <div class="panel panel-drink">
          ...
          <div class="panel-body">
            ...
            <p><a class="btn btn-drink" href="/HomeNV-wp-site/category/drink/happy-hour/"><i class="fa fa-smile-o fa-white"></i><i class="fa fa-clock-o fa-white"></i> Happy Hour &raquo;</a></p>
          </div>
        </div>
